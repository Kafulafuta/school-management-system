...
<html lang="en">
  ...
  <?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="UPDATE student SET student_name='$student_name',class='$class',dob='$dob',gender='$gender',phone='$phone' WHERE id='$id'";
		$data=mysqli_query($con,$sql);
		if($data)
		{
		echo "<p align='center' style='color: #00ff00;'>Student Updated successfull</p>";
	}
	else
	{
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Student Details</h2>
