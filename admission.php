            ...
            <ul class="navbar-nav mx-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="courses.html">Admission Enquiry</a>
                  <a class="dropdown-item" href="courses.html">Visitor Book</a>
                  <a class="dropdown-item" href="courses.html">Complaint</a>
                  <a class="dropdown-item" href="courses.html">Phone Call Log</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="courses.html">Student Admission</a>
                  <a class="dropdown-item" href="courses.html">Fees</a>
                  <a class="dropdown-item" href="courses.html">Attedance</a>
        ...
        <div class="row align-items-center justify-content-center site-hero-inner">
          <div class="col-md-10">
            ...
            <div class="mb-5 element-animate">
              <div class="block-17">
                <h2 class="heading text-center mb-4">Chile University</h2>
              </div>
            </div>
