...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE addbook SET book_title='$book_title',book_number='$book_number',isbn_number='$isbn_number',publisher='$publisher',author='$author',
	subject='$subject',qty='$qty',book_price='$book_price' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Book updatedsuccessfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Book not updated </p>";
	}
}
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              ...
              <form action="updateaddbook.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="book_title" class="form-control py-2 " value="<?php echo $book_title;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="bookno">Book Number</label>
                      <input type="text" name="book_number" class="form-control py-2 " value="<?php echo $book_number;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="isbn">ISBN Number</label>
                      <input type="text" name="isbn_number" class="form-control py-2 " value="<?php echo $isbn_number;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="publisher">Publisher</label>
                      <input type="text" name="publisher" class="form-control py-2 " value="<?php echo $publisher;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="auther">Author</label>
                      <input type="text" name="author" class="form-control py-2 " value="<?php echo $author;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="qty" class="form-control py-2 " value="<?php echo $qty;?>">
                    </div>
                  </div>
				    <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="book price">Book Price</label>
                      <input type="text" name="book_price" class="form-control py-2 " value="<?php echo $book_price;?>">
                    </div>
                  </div>
				 <div class="row">
