...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE payrol SET name='$name',roll='$roll',department='$department',designation='$designation',phone='$phone',status='$status' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Payrol updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Payrol not Updated </p>";
	}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM payrol WHERE id=$id";
$query=mysqli_query($con,$sql);
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Payroll</h2>
              <form action="updatepayrol.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="roll" class="form-control py-2 " value="<?php echo $roll;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="department">Department</label>
                      <input type="text" name="department" class="form-control py-2 " value="<?php echo $department;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="designation">Designation</label>
                      <input type="text" name="designation" class="form-control py-2 " value="<?php echo $designation;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
