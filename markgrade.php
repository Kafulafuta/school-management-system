...
if(isset($_POST['submit']))
{
	...
	$percent_upto=$_POST['percent_upto'];
	
	$sql="INSERT INTO markgrade values('$id','$grade_name','$percent_from','$percent_upto')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Grades added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Grades not Added </p>";
	}
}
...
<html lang="en">
  ...
  <body>
              ...
              <form action="#" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="grade_name" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="percent">Percent From(%)</label>
                      <input type="text" name="percent_from" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="percent">Percent Upto(%)</label>
                      <input type="text" name="percent_upto" class="form-control py-2 ">
                    </div>
                  </div>
	...
	<form action="" method="POST">
	<input type="text" name="search" placeholder="search grade name">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM markgrade WHERE id LIKE '%$searchkey%' or grade_name LIKE '%$searchkey%'";
}else{

$sql="SELECT * FROM markgrade";
}
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['percent_from']."</td>";
	echo "<td>".$row['percent_upto']."</td>";
	
	echo "<td><a href='updatemarkgrade.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletemarkgrade.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete Grades???');
}
</script>
</div>
 </div>
