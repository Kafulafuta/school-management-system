	...
	if(isset($_POST['submit']))
	{
		...
		$sql="UPDATE leavetype SET name='$name' WHERE id='$id'";
		...
		{
			echo "<p align='center' style='color: #ff0000;'>Sorry Data not Updated </p>";
		}
	}
	?>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Leave Type</h2>
              <form action="updateleavetype.php" method="post">
			        <div class="row">
