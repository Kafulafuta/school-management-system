...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO visitor values('$id','$purpose','$name','$phone','$date','$time_in','$time_out')";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>visitor added successfull</p>";
	}
	else
	{
              ...
              <form action="visitor.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="time" name="time_in" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Time Out</label>
                      <input type="time" name="time_out" class="form-control py-2 ">
                    </div>
                  </div>
					<div class="row">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM visitor WHERE phone LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='editvisitor.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletevisitor.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete A Visitor???');
}
</script>
