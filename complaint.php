...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO complaint values('$id','$complaint_type','$name','$phone','$date')";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>Complaint added successfull</p>";
	}
	else
	{
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="courses.html">Student Details</a>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Complaint</h2>
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM complaint WHERE phone LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['date']."</td>";
	echo "<td><a href='editcomplaint.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletecomplaint.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete complaint???');
}
</script>
