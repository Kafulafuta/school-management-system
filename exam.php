...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO exam values('$id','$exam_name')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Exam added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Exam not inserted </p>";
	}
}
...
<html lang="en">
  ...
  <body>
              ...
              <form action="exam.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="exam_name" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
	...
	<input type="text" name="search" placeholder="search exam name">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM exam WHERE id LIKE '%$searchkey%' or exam_name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateexam.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteexam.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete  Exam???');
}
</script>
</div>
 </div>
