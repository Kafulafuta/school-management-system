...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE staffmember SET card_number='$card_number',staff_name='$staff_name',email='$email',dob='$dob',phone='$phone' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Staff member Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Staff member not Updated</p>";
	}
}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM staffmember WHWRE id=$id";
$query=mysqli_query($con,$sql);
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Staff Member</h2>
              <form action="updatestaffmember.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="staff_name" class="form-control py-2 " value="<?php echo $staff_name;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
