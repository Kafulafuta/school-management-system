...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO hostel values('$id','$hostel_name','$type','$address','$intake')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Hostel Added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Exam not Added </p>";
	}
}
              ...
              <form action="hostel.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="hostel_name" class="form-control py-2 ">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="intake" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
