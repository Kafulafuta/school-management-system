...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-7">Add Department</h2>
	...
	<input type="text" name="search" placeholder="search department number">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM department WHERE id LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updatedepartment.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletedepartment.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete Department???');
}
</script>
</div>
 </div>
