...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO admission values('$id','$name','$phone','$source','$enquiry_date','$last_follow','$next_follow','$status')";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>Admission added successfull</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>You have entered same admission number, please try again</p>";
	}
}
...
<html lang="en">
  ...
  <body>
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="student.php">Student Admission</a>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Admission Enquiry</h2>
              <form action="admineq.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="source" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Enquiry Date</label>
                      <input type="date" name="enquiry_date" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Last Follow Update</label>
                      <input type="date" name="last_follow" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Next Follow Update</label>
                      <input type="date" name="next_follow" class="form-control py-2 ">
                    </div>
                  </div>
	...
	<input type="text" name="search" placeholder="search by phone">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM admission WHERE phone LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['last_follow']."</td>";
	echo "<td>".$row['next_follow']."</td>";
	echo "<td>".$row['status']."</td>";
	echo "<td><a href='editadmission.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteadmission.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete An equiry???');
}
</script>
