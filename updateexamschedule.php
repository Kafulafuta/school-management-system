...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE examschedule SET subject='$subject',date='$date',end_time='$end_time',room='$room',full_marks='$full_marks',passing_mark='$passing_mark'
	WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Exam Schedule Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Exam Sschedule not Updated </p>";
	}
}
...
while($result=mysqli_fetch_array($query))
{
	...
	$passing_mark=$result['passing_mark'];
}
            ...
            <ul class="navbar-nav mx-auto">
			  ...
			  <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  ...
                  <a class="dropdown-item" href="markregister">Marks Register</a>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Exam Schedule</h2>
              <form action="updateexamschedule.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="time" name="end_time" class="form-control py-2 " value="<?php echo $end_time;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="room">Room NO</label>
                      <input type="text" name="room" class="form-control py-2 " value="<?php echo $room;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="full marks">Full Marks</label>
                      <input type="text" name="full_marks" class="form-control py-2 " value="<?php echo $full_marks;?>">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="passing_mark" class="form-control py-2 " value="<?php echo $passing_mark;?>">
                    </div>
                  </div>
				 <div class="row">
