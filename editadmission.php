...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE admission SET name='$name',phone='$phone',source='$source',enquiry_date='$enquiry_date',last_follow='$last_follow',next_follow='$next_follow',
	status='$status' WHERE id='$id'";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>Admission Updated successfull</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Admission Not Updated</p>";
	}
}
?>
...
<?php
	...
	while($result=mysqli_fetch_array($query))
	{
			...
			$last_follow=$result['last_follow'];
			$next_follow=$result['next_follow'];
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Admission Enquiry</h2>
              <form action="editadmission.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="source" class="form-control py-2 " value="<?php echo $source;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Enquiry Date</label>
                      <input type="date" name="enquiry_date" class="form-control py-2 " value="<?php echo $enquiry_date;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Last Follow Update</label>
                      <input type="date" name="last_follow" class="form-control py-2 " value="<?php echo $last_follow;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Next Follow Update</label>
                      <input type="date" name="next_follow" class="form-control py-2 " value="<?php echo $next_follow;?>">
                    </div>
                  </div>
