...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE exam SET exam_name='$exam_name' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Exam Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Exam not Updated </p>";
	}
}
              ...
              <form action="updateexam.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="exam_name" class="form-control py-2 " value="<?php echo 	$exam_name;?>">
                    </div>
                  </div>
				   <div class="row">
