...
if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Department Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Department not Updated</p>";
	}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-7">Update Department</h2>
