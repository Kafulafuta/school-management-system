...
if (isset($_POST['submit']))
{
	...
	$sql="UPDATE applyleave SET staff='$staff',leave_type='$leave_type',leave_date='$leave_date',days='$days',apply_date='$apply_date',status='$status' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Data Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Sorry, update process failed</p>";
	}
}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM applyleave WHERE id=$id";
$query=mysqli_query($con,$sql);
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Leave</h2>
              <form action="updateapproveleave.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="staff" class="form-control py-2" value="<?php echo $staff;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="leave type">Leave Type</label>
                      <input type="text" name="leave_type" class="form-control py-2 " value="<?php echo $leave_type;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="leave date">Leave Date</label>
                      <input type="date" name="leave_date" class="form-control py-2 " value="<?php echo $leave_date;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="days">Days</label>
                      <input type="text" name="days" class="form-control py-2 " value="<?php echo $days;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="apply days">Apply Date</label>
                      <input type="date" name="apply_date" class="form-control py-2 " value="<?php echo $apply_date;?>">
                    </div>
                  </div>
