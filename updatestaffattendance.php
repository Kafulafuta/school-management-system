...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE attendance SET staff_number='$staff_number',name='$name',role='$role',attendance='$attendance' WHERE id='$id'";
	...
	{
		echo "<p align='center' style='color: #ff0000;'>Data not Updated </p>";
	}
}
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Staff Attendance</h2>
              <form action="updatestaffattendance.php" method="post">
                  
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Id</label>
                      <input type="text" name="id" class="form-control py-2 required" value="<?php echo $id;?>">
                    </div>
                  </div>
					<div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Staff Number</label>
                      <input type="text" name="staff_number" class="form-control py-2 required" value="<?php echo $staff_number;?>" >
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">name</label>
                      <input type="text" name="name" class="form-control py-2  required" value="<?php echo $name;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Role</label>
                      <input type="text" name="role" class="form-control py-2 required" value="<?php echo $role;?>">
                    </div>
                  </div>
