...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO hostelroom values('$id','$room_number','$hostel','$room_type','$bed_number','$bed_cost')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Hostel Room Added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Hostel Room not Added </p>";
	}
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Hostel Room</h2>
              <form action="hostelroom.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="room_number" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="form-group">
					<label for="type">Hostel</label>
				   ...
				   <div class="form-group">
					...
					<select class="form-control" name="bed_number">
					  ...
					  <option>one Bed</option>
					   <option>Two Beds</option>
					    <option>Three Beds</option>
					   <option>Four Beds</option>
					  </select>
					  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="cost">Cost Per Bed</label>
                      <input type="text" name="bed_cost" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM hostelroom WHERE room_number LIKE '%$searchkey%' or room_number LIKE '%$searchkey%'";
}else{

$sql="SELECT * FROM hostelroom";
}
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['bed_cost']."</td>";
	
	echo "<td><a href='updatehostelroom.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletehostelroom.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete  Room Hostel???');
}
</script>
</div>
 </div>
