...
if(isset($_POST['update'])){
	...
	$balance=$_POST['balance'];
		...
		$sql="UPDATE fees SET student_name='$student_name',class='$class',phone_number='$phone_number',total_fees='$total_fees',paid_fees='$paid_fees',
		balance='$balance' WHERE id='$id'";
		$query=mysqli_query($con,$sql);
		if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Fees Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Fees not Updated</p>";
	}
              ...
              <form action="updatefees.php" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="student_name" class="form-control py-2" value="<?php echo $student_name;?>">
					</div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Class</label>
                      <input type="text" name="class" class="form-control py-2" value="<?php echo $class;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="phone">Phone Number</label>
                      <input type="text" name="phone_number" class="form-control py-2 " value="<?php echo $phone_number;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="fees">Total Fees</label>
                      <input type="text" name="total_fees" class="form-control py-2 " value="<?php echo $total_fees;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="fees">Paid Fees</label>
                      <input type="text" name="paid_fees" class="form-control py-2" value="<?php echo $paid_fees;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="balance">Balance</label>
                      <input type="text" name="balance" class="form-control py-2 " value="<?php echo $balance;?>">
                    </div>
                  </div>
					
				   <div class="row">
                    <div class="col-md-6 form-group">
                      <input type="submit" name="update" value="Update" class="btn btn-primary px-5 py-2">
                    </div>
                  </div>
                </form>
				  </div>
