...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO issuereturn values('$id','$book_title','$card_number','$name','$publisher','$member','$phone')";
	$query=mysqli_query($con,$sql);
	if($query)
		{
		echo "<p align='center' style='color: #00ff00;'>Returns inserted successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Returns not inserted </p>";
	}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Issue Return</h2>
				  ...
				  <div class="row">
				   ...
				   <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="member" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM issuereturn WHERE id LIKE '%$searchkey%' or book_title LIKE '%$searchkey%'";
}else{

$sql="SELECT * FROM issuereturn";
}
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateissuereturn.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteissuereturn.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete a return book???');
}
</script>
</div>
 </div>
