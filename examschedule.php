...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO examschedule values('$id','$subject','$date','$end_time','$room','$full_marks','$passing_mark')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Exam Schedule added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Exam Sschedule not inserted </p>";
	}
}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Exam Schedule</h2>
              <form action="examschedule.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="date" name="date" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="time">End Time</label>
                      <input type="time" name="end_time" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="room">Room NO</label>
                      <input type="text" name="room" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="full marks">Full Marks</label>
                      <input type="text" name="full_marks" class="form-control py-2 ">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="passing">Passing Mark</label>
                      <input type="text" name="passing_mark" class="form-control py-2 ">
                    </div>
                  </div>
				 <div class="row">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM examschedule WHERE id LIKE '%$searchkey%' or subject LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['passing_mark']."</td>";
	
	echo "<td><a href='updateexamschedule.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteexamschedule.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete  Exam Schedule???');
}
</script>
</div>
 </div>
