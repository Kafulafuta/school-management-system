...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO markregister values('$id','$student_name','$web','$database','$android','$internet','$networking')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Marks added successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Marks not Added </p>";
	}
}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Marks Register</h2>
              <form action="markregister.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Web Engineering</label>
                      <input type="text" name="web" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="database">Database</label>
                      <input type="text" name="database" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="room">Android</label>
                      <input type="text" name="android" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="internet">Internet Security</label>
                      <input type="text" name="internet" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="networking">Networking</label>
                      <input type="text" name="networking" class="form-control py-2 ">
                    </div>
                  </div>
				 <div class="row">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM markregister WHERE id LIKE '%$searchkey%' or subject LIKE '%$searchkey%'";
}else{

$sql="SELECT * FROM markregister";
}
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['networking']."</td>";
	
	echo "<td><a href='updatemarkregister.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletemarkregister.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete register ???');
}
</script>
</div>
 </div>
