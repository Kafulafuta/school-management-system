...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE markregister SET student_name='$student_name',web='$web',database='$database',android='$android',internet='$internet',networking='$networking'
	WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Marks updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Marks not Updated </p>";
	}
}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM markregister WHERE id=$id";
$query=mysqli_query($con,$sql);
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Marks Register</h2>
              <form action="updatemarkregister.php" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="web" class="form-control py-2 " value="<?php echo $web;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="database">Database</label>
                      <input type="text" name="database" class="form-control py-2 " value="<?php echo $database;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="room">Android</label>
                      <input type="text" name="android" class="form-control py-2 " value="<?php echo $android;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="internet">Internet Security</label>
                      <input type="text" name="internet" class="form-control py-2 " value="<?php echo $internet;?>">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="networking">Networking</label>
                      <input type="text" name="networking" class="form-control py-2 " value="<?php echo $networking;?>">
                    </div>
                  </div>
				 <div class="row">
