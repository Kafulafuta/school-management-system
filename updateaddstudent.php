...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE addstudent SET card_number='$card_number',student_name='$student_name',class='$class',dob='$dob',gender='$gender',phone='$phone' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Student Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Student not Updated </p>";
	}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Student</h2>
              <form action="updateaddstudent.php" method="post">
				  ...
				  <div class="row">
				   ...
				   <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="date" name="dob" class="form-control py-2 " value="<?php echo $dob;?>">
                    </div>
                  </div>
