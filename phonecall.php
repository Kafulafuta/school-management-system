...
if(isset($_POST['submit']))
{
	...
	$phone=$_POST['phone'];
	$date=$_POST['date'];
	$follow_update=$_POST['follow_update'];
	$call_type=$_POST['call_type'];
	
	$sql="INSERT INTO phonecall values('$id','$name','$phone','$date','$follow_update','$call_type')";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>Phone call added successfull</p>";
	}
	else
	{
            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="courses.html">Fees</a>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Phone Call Log</h2>
              <form action="phonecall.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="date" name="follow_update" class="form-control py-2 ">
                    </div>
                  </div>
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM phonecall WHERE phone LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td>".$row['date']."</td>";
	echo "<td>".$row['follow_update']."</td>";
	echo "<td>".$row['call_type']."</td>";
	echo "<td><a href='editphonecall.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletephonecall.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
