...
if(isset($_POST['submit']))
{
    ...
    $sql="UPDATE complaint SET complaint_type='$complaint_type',name='$name',phone='$phone',date='$date' WHERE id='$id'";
	$data=mysqli_query($con,$sql);
	if($data)
	{
		echo "<p align='center' style='color: #00ff00;'>Complaint Updated successfull</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Complaint Not Updated</p>";
	}
}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Complaint</h2>
              <form action="editcomplaint.php" method="POST">
