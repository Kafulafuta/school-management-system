...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO attendance VALUES('$id','$staff_number','$name','$role','$attendance')";
	...
	{
		"<p align='center' style='color: #ff0000;'>Data not inserted </p>";
	}
}
...
<html lang="en">
  ...
  <body>
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Staff Attendance</h2>
              <form action="staffattend.php" method="post">
                  
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Id</label>
                      <input type="text" name="id" class="form-control py-2" required>
                    </div>
                  </div>
					<div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name">Staff Number</label>
                      <input type="text" name="staff_number" class="form-control py-2 required" >
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="role" class="form-control py-2 required">
                    </div>
                  </div>
	...
	<input type="text" name="search" placeholder="search staff number">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM attendance WHERE staff_number LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}
else
{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updatestaffattendance.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletestaffattendance.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete attendance???');
}
</script>
</div>
 </div>
