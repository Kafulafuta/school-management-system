...
if (isset($_POST['submit']))
{
	...
	$sql="INSERT INTO applyleave VALUES('$id','$staff','$leave_type','$leave_date','$days','$apply_date','$status')";
	...
	{
		echo "<p align='center' style='color: #ff0000;'>Data not inserted </p>";
	}
}
...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav mx-auto">
			  ...
			  <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  ...
                  <a class="dropdown-item" href="addmember.php">Add Staff Member</a>
                </div>
              ...
              <form action="approveleave.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="staff" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="leave type">Leave Type</label>
                      <input type="text" name="leave_type" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="leave date">Leave Date</label>
                      <input type="date" name="leave_date" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="days">Days</label>
                      <input type="text" name="days" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="apply days">Apply Date</label>
                      <input type="date" name="apply_date" class="form-control py-2 ">
                    </div>
                  </div>
	...
	<input type="text" name="search" placeholder="search staff or id number">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM applyleave WHERE id LIKE '%$searchkey%' or staff LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateapproveleave.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteapproveleave.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete Staff Leave???');
}
</script>
</div>
 </div>
