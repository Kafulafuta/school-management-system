...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO addbook values('$id','$book_title','$book_number','$isbn_number','$publisher','$author','$subject','$qty','$book_price')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Book inserted successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Book not inserted </p>";
	}
}
            ...
            <ul class="navbar-nav mx-auto">
			  ...
			  <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  ...
                  <a class="dropdown-item" href="addstaffmember.php">Add Staff Member</a>
                </div>
              ...
              <form action="addbook.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="book_title" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="bookno">Book Number</label>
                      <input type="text" name="book_number" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="isbn">ISBN Number</label>
                      <input type="text" name="isbn_number" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="publisher">Publisher</label>
                      <input type="text" name="publisher" class="form-control py-2 ">
                    </div>
                  </div>
				   <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="auther">Author</label>
                      <input type="text" name="author" class="form-control py-2 ">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="qty" class="form-control py-2 ">
                    </div>
                  </div>
				    <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="book price">Book Price</label>
                      <input type="text" name="book_price" class="form-control py-2 ">
                    </div>
                  </div>
				 <div class="row">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM addbook WHERE id LIKE '%$searchkey%' or book_title LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateaddbook.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteaddbook.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete a book???');
}
</script>
</div>
 </div>
