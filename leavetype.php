...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO leavetype VALUES('$id','$name')";
...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Leave Type</h2>
	...
	<input type="text" name="search" placeholder="search leave type or id number">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM leavetype WHERE id LIKE '%$searchkey%' or name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateleavetype.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteleavetype.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
