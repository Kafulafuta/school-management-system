...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO addstudent values('$id','$card_number','$student_name','$class','$dob','$gender','$phone')";
	...
	{
		echo "<p align='center' style='color: #ff0000;'>Student not inserted </p>";
	}
...
<html lang="en">
  ...
  <body>
	...
	<input type="text" name="search" placeholder="search student_name or card_number">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM addstudent WHERE card_number LIKE '%$searchkey%' or student_name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updateaddstudent.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deleteaddstudent.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete student details???');
}
</script>
</div>
 </div>
