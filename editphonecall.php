...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE phonecall SET name='$name',phone='$phone',date='$date',follow_update='$follow_update',call_type='$call_type' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Phone call Updated successfull</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Phone Call not Updated</p>";
	}
}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM phonecall WHERE id=$id";
$query=mysqli_query($con,$sql);
while($res=mysqli_fetch_array($query))
{
	...
	$phone=$res['phone'];
	$date=$res['date'];
	$follow_update=$res['follow_update'];
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Phone Call Log</h2>
              <form action="editphonecall.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="date" name="follow_update" class="form-control py-2 " value="<?php echo 	$follow_update;?>">
                    </div>
                  </div>
