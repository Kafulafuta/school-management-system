...
<html lang="en">
  ...
  <?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="INSERT INTO student values('$id','$student_name','$class','$dob','$gender','$phone_number')";
		$data=mysqli_query($con,$sql);
		if($data)
		{
		echo "<p align='center' style='color: #00ff00;'>Student Added Successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Student Not Added</p>";
	}
	}
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Student Details</h2>
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM student WHERE id LIKE '%$searchkey%' or student_name LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updatestudent.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletestudent.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
