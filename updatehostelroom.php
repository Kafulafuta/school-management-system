...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE hostelroom SET room_number='$room_number',hostel='$hostel',room_type='$room_type',bed_number='$bed_number',bed_cost='$bed_cost' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Hostel Room Updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Hostel Room not Updated</p>";
	}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM hostelroom WHERE id=$id";
$query=mysqli_query($con,$sql);
	...
	<section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Hostel Room</h2>
              <form action="updatehostelroom.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="room_number" class="form-control py-2 " value="<?php echo $room_number;?>">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="bed_cost" class="form-control py-2 " value="<?php echo $bed_cost;?>">
                    </div>
                  </div>
				   <div class="row">
