...
if(isset($_POST['submit']))
{
	...
	$sql="UPDATE issuereturn SET book_title='$book_title',card_number='$card_number',name='$name',publisher='$publisher',member='$member',phone='$phone' WHERE id='$id'";
	$query=mysqli_query($con,$sql);
	if($query)
		{
		echo "<p align='center' style='color: #00ff00;'>Returns updated successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Returns not updated </p>";
	}
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM issuereturn WHERE id=$id";
$query=mysqli_query($con,$sql);
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Update Issue Return</h2>
              <form action="#" method="post">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="card_number" class="form-control py-2 " value="<?php echo $card_number;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
				  ...
				  <div class="row">
				   ...
				   <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="member" class="form-control py-2 " value="<?php echo $member;?>">
                    </div>
                  </div>
				  <div class="row">
                    <div class="col-md-12 form-group">
