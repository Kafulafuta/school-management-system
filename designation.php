...
if(isset($_POST['submit']))
{
	$id=$_POST['id'];
	$name=$_POST['name'];
	$sql="INSERT INTO designation VALUES('$id','$name')";
	$query=mysqli_query($con,$sql);
	if($query)
	{
		echo "<p align='center' style='color: #00ff00;'>Designation inserted successfully</p>";
	}
	else
	{
		echo "<p align='center' style='color: #ff0000;'>Designation not inserted </p>";
	}
}
...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5">Add Designation</h2>
	...
	<input type="text" name="search" placeholder="search designation name">
...
if(isset($_POST['add']))
{
	...
	$sql="SELECT * FROM designation WHERE id LIKE '%$searchkey%' or designation LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='updatedesignation.php?id=$row[id]' class='btn btn-success'>Edit</a></td>";
	echo "<td><a href='deletedesignation.php?id=$row[id]' onclick='return checkdelete()' class='btn btn-danger'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete Designation???');
}
</script>
</div>
 </div>
